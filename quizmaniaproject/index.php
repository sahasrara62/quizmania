...
function validateForm() {
	...
	var z =document.forms["form"]["college"].value;if (z == null || z.trim().length == "") {alert("college must be filled out.");return false;}else if(!z.match(letters)){alert("College must be filled out correctly."); return false;}
	...
	var a = document.forms["form"]["password"].value;if(a == null || a.trim().length == ""){alert("Password must be filled out correctly");return false;}
	if(a.length<5 || a.length>25){alert("Passwords must be 5 to 25 characters long.");return false;}
    var b = document.forms["form"]["cpassword"].value;
	if(b == null || b.trim().length == ""){alert(" Confirm Password must be filled out");return false;}
